...
class Level_TestGoToBlocked(RoomGridLevel):
    ...
    def __init__(self, seed=None):
        super().__init__(num_rows=1, num_cols=1, room_size=9, seed=seed)
...
class Level_TestPutNextToBlocked(RoomGridLevel):
    ...
    def gen_mission(self):
        ...
        self.instrs = PutNextInstr(
            ObjDesc(obj1.type, obj1.color), ObjDesc(obj2.type, obj2.color)
        )
...
class Level_TestPutNextToCloseToDoor1(RoomGridLevel):
    ...
    def __init__(self, seed=None):
        super().__init__(num_rows=2, num_cols=1, room_size=9, seed=seed)
    ...
    def gen_mission(self):
        ...
        self.instrs = BeforeInstr(
            ...
            PutNextInstr(
                ObjDesc(self.obj1.type, self.obj1.color),
...
class Level_TestPutNextToIdentical(RoomGridLevel):
    ...
    def gen_mission(self):
        ...
        instr1 = PutNextInstr(ObjDesc("ball", "blue"), ObjDesc("box", "yellow"))
        instr2 = PutNextInstr(ObjDesc("box", "yellow"), ObjDesc("ball", None))
...
class Level_TestUnblockingLoop(RoomGridLevel):
    ...
    def __init__(self, seed=None):
        super().__init__(num_rows=2, num_cols=2, room_size=9, seed=seed)
...
class Level_TestLotsOfBlockers(RoomGridLevel):
    ...
    def __init__(self, seed=None):
        super().__init__(num_rows=1, num_cols=1, room_size=8, seed=seed)
    ...
    def gen_mission(self):
        ...
        self.instrs = PutNextInstr(ObjDesc("ball", "red"), ObjDesc("ball", "blue"))
